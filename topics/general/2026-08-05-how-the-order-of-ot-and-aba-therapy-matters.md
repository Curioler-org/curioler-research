...
The strongest source here is a 2025 parallel-arm comparative effectiveness trial in Autism Research that randomised autistic children with sensory differences to OT using Ayres Sensory Integration, to ABA, or to no treatment - a design that compares the therapies but never sequences them. It is supported by a 2021 peer-reviewed paper in Behavior Analysis in Practice on collaboration between the two professions, and its claims about ABA have been challenged in a subsequent commentary in Autism Research. No systematic review or trial addressing therapy order was located, which is the central finding of this summary rather than a gap in the search: on the specific question of sequence, the evidence base is close to empty.

## Sources

- [A Comparative Trial of Occupational Therapy Using Ayres Sensory Integration and Applied Behavior Analysis Interventions for Autistic Children](https://doi.org/10.1002/aur.70099) — Schaaf et al., 2025, Autism Research, 18(10), 2120-2134
- [Clarifying the ABA Comparison and Equivalence Claims in Schaaf et al. (2025)](https://doi.org/10.1002/aur.70184) — Chang, 2025, Autism Research (commentary)
- [Collaboration between Behavior Analysts and Occupational Therapists in Autism Service Provision: Bridging the Gap](https://link.springer.com/article/10.1007/s40617-021-00619-y) — Behavior Analysis in Practice, 2021
- [A Review of 'Collaboration between behavior analysts and occupational therapists in autism service provision'](https://asatonline.org/research-treatment/book-reviews/review-of-collaboration/) — Association for Science in Autism Treatment
- [An evaluation of the effects of intensity and duration on outcomes across treatment domains for children with autism spectrum disorder](https://www.nature.com/articles/tp2017207) — Translational Psychiatry, 2017
- [Sensory-based Interventions](https://asatonline.org/for-parents/learn-more-about-specific-treatments/sensory-based-interventions/) — Association for Science in Autism Treatment
