...
This summary draws on guidance and educational resources from five organisations — the UK's National Autistic Society, the University of Nebraska's SCADD Lab, the University of Kansas School of Education, the Autism Research Institute, and Indiana University's Indiana Resource Center for Autism. The NAS page in particular synthesises a substantial body of peer-reviewed studies (covering gestures, joint attention, empathy, prosody, language development, and intervention approaches) alongside lived experience from autistic adults and parents. The Autism Research Institute material is based on a recorded academic presentation by Dr. Matthew Lerner (Stony Brook University), reviewing research on mechanisms underlying social development. Together these sources represent current clinical and research consensus rather than a single systematic review.
