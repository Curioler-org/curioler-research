---
title: "We shouldn't do brushing in OT to kids with epilepsy and seizure history"
statement: "We shouldn't do brushing in OT to kids with epilepsy and seizure history"
verdict: "nuanced"
...
1. **Consult the child's neurologist** before initiating the brushing protocol — understand the specific seizure type and whether tactile triggers have been identified
2. **Review the seizure history carefully** — are seizures controlled? Have tactile triggers ever been identified?
3. **Apply the protocol only under OT supervision** and never train parents to use it at home without confirmed safety in a supervised setting
4. **Err on the side of caution for uncontrolled or incompletely characterised epilepsy** — not because brushing is proven harmful, but because the seizure profile is not yet fully understood
...
- [Reflex Epilepsy — AboutKidsHealth](https://www.aboutkidshealth.ca/reflex-epilepsy)
- [Reflex Myoclonic Epilepsy of Infancy: Seizures Induced by Tactile Stimulation — Journal of Pediatrics / PubMed](https://pubmed.ncbi.nlm.nih.gov/27039230/)
- [Reflex Seizures and Reflex Epilepsies — NCBI Bookshelf](https://www.ncbi.nlm.nih.gov/books/NBK2596/)
- [Therapeutic Brushing Techniques — OT-Innovations](https://www.ot-innovations.com/clinical-practice/sensory-modulation/therapeutic-brushing-techniques/)
- [There is no evidence that a brushing protocol is an effective intervention — UW-La Crosse CAT Review](https://www.uwlax.edu/globalassets/academics/grad/occupational-therapy/cats/2013-14/brushing.pdf)
- [Treatment summary for Wilbarger Brushing Protocol — ASAT](https://asatonline.org/for-parents/learn-more-about-specific-treatments/the-wilbarger-brushing-protocol-1/)
- [Reflex seizure triggers — Epilepsy Action](https://www.epilepsy.org.uk/info/seizure-triggers/reflex-epilepsies)
