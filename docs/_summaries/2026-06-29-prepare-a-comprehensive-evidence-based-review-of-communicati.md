...
**Source:** Brignell et al., Cochrane Database of Systematic Reviews (2018); supplemented by Theodoratou (2024) and practitioner resources from Indiana University IRCA and LeafWing Center
**Evidence level:** Tier 1 — Systematic Review (primary source), with Tier 2–4 supporting sources
**Domain:** Communication
...
The primary source is a Cochrane systematic review (Brignell et al., 2018), which searched 18 databases and identified two randomised controlled trials (154 children aged 32 months to 11 years) comparing communication interventions to a control group in minimally verbal autistic children. The review followed rigorous Cochrane methodology, including independent screening, risk-of-bias assessment, and GRADE evidence quality ratings. Supporting context was drawn from a 2024 peer-reviewed mini-review on ADHD-ASD communication comorbidity (Theodoratou, 2024), and practitioner guidance from Indiana University's Resource Center for Autism and the LeafWing Center, which synthesise evidence-based practices used in clinical settings.
