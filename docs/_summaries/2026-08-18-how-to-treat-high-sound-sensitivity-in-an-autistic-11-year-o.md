---
title: "Sound Sensitivity in an Autistic 11-Year-Old: What Actually Helps"
...
This summary is built from several sources rather than one study, because no single study covers the question. The strongest piece is a Cochrane review — the most rigorous kind there is — which found no evidence for listening programmes. Around it sit a 2025 review of sound-based approaches in children, research establishing how common sound sensitivity is in autism and what forms it takes, small studies of ear defenders and noise-cancelling earbuds, and practical guidance from NHS audiology services and the National Autistic Society. Be aware the quality is uneven: the Cochrane finding is solid, but no large trial has tested a full approach specifically in autistic children, so several of the practical recommendations here rest on clinical experience rather than hard proof.
